...
/**
 * <p>Java class for dataCategoriaArray complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{http://servidor/}dataCategoria" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DataCategoriaArray {
    ...
    public List<DataCategoria> getItem() {
        if (item == null) {
            item = new ArrayList<DataCategoria>();
        }
        return this.item;
    }
